...
[providers]
keychain = { type = "keychain", service = "exemplar" }
pass = { type = "password-store", prefix = "exemplar/" }
...
edition = "2024"
rust-version = "1.93.1"
homepage = "https://github.com/DenisGorbachev/exemplar"
repository = "https://github.com/DenisGorbachev/exemplar"
keywords = []
categories = []
exclude = [
    ".*",
